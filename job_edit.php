                    ...
                    <div class="table">
                        ...
                        <form action="job_edit_action.php" method="POST">
                            <table class="listing form" cellpadding="0" cellspacing="0">
                                <tr>
                                    <th class="full" colspan="2">Update Job Details</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="last"><textarea name="description" rows="4" cols="41">' . $row['description'] . '</textarea></td>
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>Hours</strong></td>
                                    <td class="last"><input type="text" class="text" name="hours" value="' . $row['hours'] . '"/></td>
                                </tr>
