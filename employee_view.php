                    ...
                    <div class="table">
                        ...
                        echo'
                            ...
                            <table class="listing form" cellpadding="0" cellspacing="0">
                                <tr>
                                    <th class="full" colspan="2">View Employee Details</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="last"><input type="text" class="text" name="name" value="' . $row['name'] . '"  readonly="readonly" /></td>
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>Address</strong></td>
                                    <td class="last"><textarea name="address" rows="4" cols="41"  readonly="readonly" >' . $row['address'] . '</textarea></td>
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>DOB</strong></td>
                                    <td class="last"><input type="text" class="text" name="dob" value="' . $row['dob'] . '"  readonly="readonly" /></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="last"><input type="text" class="text" name="mobile" value="' . $row['mobile'] . '"  readonly="readonly" /></td>
                                    
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>Email ID</strong></td>
                                    <td class="last"><input type="text" class="text" name="email" value="' . $row['email'] . '"  readonly="readonly" /></td>
                                </tr>
                                <tr class="bg">
                        ...
                        echo '<input type="text" class="text" name="email" value="' . $row2['description'] . '"  readonly="readonly" /> </td>
                        </tr>
                        <tr><td></td><td></td></tr>
                        </table>
                        ...
                        <div class = "top-bar">
                        <h2>Reports</h2>
                        <a href = "manager_view_attendance.php?id='.filter_input(INPUT_GET, 'id').'" class = "button">Attendance</a>
                        <a href = "employee_salary_calculation.php?id='.filter_input(INPUT_GET, 'id').'" class = "button">Salary</a>
                        </div><br/> ';
                        ?>
