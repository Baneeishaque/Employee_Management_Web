        ...
        <div id="main">
            ...
            <div id="middle">
                ...
                <div id="center-column">
                    <div class="top-bar">
                        <a href="designation_addition.php" class="button">+</a>
...
<tr>
                                <th class="first" width="177">Description</th>
                                <th>Working Hours</th>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <td class="first style2">' . $row['working-hours'] . '</td>
                                <td class="first style2">' . $row['allowed-leaves'] . '</td>
                                <td class="first style2">' . $row['salary'] . '</td>
                                
                                <td><a href="designation_edit.php?id='.$row['id'].'"><img src="img/edit-icon.gif" width="16" height="16" alt="edit"/></a></td>
                                <td><a href="designation_delete_action.php?id='.$row['id'].'"><img src="img/hr.gif" width="16" height="16" alt=""/></a></td>
                            </tr>';
                            }
                        }
                        ?>
