            ...
            <div id="middle">
                ...
                <div id="center-column">
                    ...
                    <div class="table">
                        ...
                        <form action="designation_addition_action.php" method="POST">
                            <table class="listing form" cellpadding="0" cellspacing="0">
                                <tr>
                                    <th class="full" colspan="2">Add Designation Details</th>
                                </tr>
                                <tr>
                                ...
                                <tr class="bg">
                                    ...
                                    <td class="last"><input type="text" class="text" name="salary"/></td>
                                </tr>
