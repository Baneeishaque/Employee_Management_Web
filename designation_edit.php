                ...
                <div id="center-column">
                    ...
                    <div class="table">
                       ...
                       $row = mysqli_fetch_assoc($result);
                            echo '<form action="designation_edit_action.php" method="POST">
                            <table class="listing form" cellpadding="0" cellspacing="0">
                                <tr>
                                    <th class="full" colspan="2">Update Designation Details</th>
                                </tr>
                                <tr>

                                    <td class="first" width="172"><strong>Designation ID</strong></td>
                                ...
                                <tr>
                                    ...
                                    <td class="last"><input type="text" class="text" name="description" value="' . $row['description'] .'"/></td>
                                    
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>Working Hours</strong></td>
                                    <td class="last"><input type="text" class="text" name="working-hours" value="' . $row['working-hours'] .'"/></td>
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>Allowed Leaves</strong></td>
                                    <td class="last"><input type="text" class="text" name="allowed-leaves" value="' . $row['allowed-leaves'] .'"/></td>
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>Salary</strong></td>
                                    <td class="last"><input type="text" class="text" name="salary" value="' . $row['salary'] .'"/></td>
                                </tr>
